...
const { updateEfficiency, generateUpdateEfficiencyScript } = require('../../src/update'), { getConnectionInformation } = require('../../src/util');
...
exports.handler = function(argv) {
    ...
    if (argv.offline) {
        ...
        updateEfficiency(cli, argv.rchainid, argv.efficiency, argv.sk1, argv.secaddress)
            .then(function(data) {
