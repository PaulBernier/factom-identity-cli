...
const program = require('commander'),
    { updateCoinbaseAddress, generateUpdateCoinbaseAddressScript } = require('../src/update'),
...
program
    ...
    .description('Update coinbase address or generate a script to update coinbase address')
...
program.on('--help', function() {
    ...
    console.log('    $ factom-identity-cli update-coinbase-address --offline -s localhost:8088 888888b2e7c7c63655fa85e0b0c43b4b036a6bede51d38964426f122f61c5584 FA24PAtyZWWVAPm95ZCVpwyY6RYHeCMTiZt2v4VQAY8aBXMUZyeF sk12J1qQCjTRtnJ15bmb1iSinEvtzgQMBi5szzV793LUJQib36pvz Es3ytEKt4R55M9juC4ks7EgxQSX8BpRnM4WADthFoq7j1WgbEEGW\n');
});
...
if (program.offline) {
    ...
    console.log(`Generating script to update coinbase address of Identity [${rootChainId}] with [${fctAddress}]...`);
    generateUpdateCoinbaseAddressScript(rootChainId, fctAddress, sk1, ecPrivateAddress, factomdInformation);
